...
const sortChange = async () => {
  ...
  arr.push(data.operationRecordData.filter((p: any) => p.title == "核价工作分配"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "TR方案审核"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "产品开发部TR主方案审核"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "电子bom"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "电子bom审核"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "结构bom"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "结构bom审核"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "电子单价"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "电子单价审核"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "结构单价"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "结构单价审核"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "制造费用"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "电子损耗"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "结构损耗"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "物流费用"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "SMT/COB制造费用"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "模具费用"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "检具费用"))
  ...
  arr.push(data.operationRecordData.filter((p: any) => p.title == "报价回传"))
  arr.push(data.operationRecordData.filter((p: any) => p.title == "归档（项目部）"))
